...
public class WalkWithBlockAnimation 
{
	...
	public static void start(ArmorStand aS) {
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                aS.setRightArmPose(new EulerAngle(Math.toRadians(299.0), Math.toRadians(345.0), Math.toRadians(0.0)));
                aS.setLeftArmPose(new EulerAngle(Math.toRadians(299.0), Math.toRadians(12.0), Math.toRadians(0.0)));
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                aS.setLeftLegPose(new EulerAngle(Math.toRadians(348.0), Math.toRadians(0.0), Math.toRadians(0.0)));
                aS.setHeadPose(new EulerAngle(Math.toRadians(0.0), Math.toRadians(0.0), Math.toRadians(8.0)));
                WalkWithBlockAnimation.start(aS);
                this.cancel();
            }
